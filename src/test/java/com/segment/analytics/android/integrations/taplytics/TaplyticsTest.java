...
@PrepareForTest(Taplytics.class) public class TaplyticsTest {
  ...
  @Test public void factory() {
    ValueMap settings = new ValueMap() //
        .putValue("apiKey", "foo")
        .putValue("liveUpdate", TaplyticsIntegration.DEFAULT)
  ...
  @Test public void activityCreate() {
    ValueMap settings = new ValueMap().putValue("turnMenu", 2)
        .putValue("sessionMinutes", 10)
        .putValue("liveUpdate", 1)
        .putValue("shakeMenu", 1)
        .putValue("delayedStartTaplytics", 1);
